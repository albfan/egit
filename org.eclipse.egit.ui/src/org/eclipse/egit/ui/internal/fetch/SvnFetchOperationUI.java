...
import org.eclipse.egit.core.op.SvnFetchOperation;
 ...
 */
public class SvnFetchOperationUI {
	private final Repository repository;

	private final SvnFetchOperation op;
	 ...
	 *
	 */
	public SvnFetchOperationUI(Repository repository, SvnRemoteConfig config,
                               int timeout, boolean dryRun) {
		this.repository = repository;
		op = new SvnFetchOperation(repository, config, timeout, dryRun);
	 ...
	 * @param dryRun
	 */
	public SvnFetchOperationUI(Repository repository, URIish uri,
                               List<RefSpec> specs, int timeout, boolean dryRun) {
		this.repository = repository;
		op = new SvnFetchOperation(repository, uri, specs, timeout, dryRun);
